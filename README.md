...
- **v0.70** — **Legacy-artifact sweep, part 4: internal naming.** Final part
...
- **v0.69** — **Legacy-artifact sweep, part 3: the worker-hours vocabulary.**
...
- **v0.68** — **Legacy-artifact sweep, part 2: dead files.** Second part
